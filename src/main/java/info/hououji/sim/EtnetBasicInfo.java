...
//		}
	...
	public EtnetBasicInfo(String code) {
		this.code = code ;
		try{
			String html = "" ;
			Document doc ;

			URL url = new URL("http://www.etnet.com.hk/www/tc/stocks/realtime/quote_ci_basicdata.php?code=" + code) ;
...
//			ex.printStackTrace();
	...
	public static void main(String args[]) throws Exception {
		EtnetBasicInfo ebi = new EtnetBasicInfo("0001") ;
		System.out.println("ebi.name:"+ebi.name) ;
		System.out.println(ebi.dataset.toString()) ;
		System.out.println(ebi.dataset.getStr("市值 (港元)")) ;
	}
